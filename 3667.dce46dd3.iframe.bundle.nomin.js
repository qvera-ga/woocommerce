"use strict";
(self["webpackChunk_woocommerce_storybook"] = self["webpackChunk_woocommerce_storybook"] || []).push([[3667],{
...
__webpack_require__.d(payment_settings_actions_namespaceObject, {
  ...
  hideGatewaySuggestion: () => (hideGatewaySuggestion),
  togglePaymentGateway: () => (togglePaymentGateway),
  updateOfflinePaymentGatewayOrdering: () => (updateOfflinePaymentGatewayOrdering)
});
...
var data_build_module = __webpack_require__("../../node_modules/.pnpm/@wordpress+data@6.6.2_react@17.0.2/node_modules/@wordpress/data/build-module/index.js");
  ...
  return regenerator_default().wrap(function deactivatePlugin$(_context9) {
    while (1) switch (_context9.prev = _context9.next) {
      case 0:
        ...
        _context9.next = 3;
        return (0,data_controls_build_module/* apiFetch */.nr)({
          path: 'wp/v2/plugins/' + pluginName + '/' + pluginName,
          // WP API specifics
          method: 'POST',
          data: {
            status: 'inactive'
  ...
  return regenerator_default().wrap(function updateProfileItems$(_context2) {
    while (1) switch (_context2.prev = _context2.next) {
      ...
      case 24:
        _context2.prev = 24;
        _context2.next = 27;
        return (0,data_build_module/* dispatch */.JD)(options_constants_STORE_NAME).invalidateResolution('getOption', ['woocommerce_onboarding_profile']);
      case 27:
        _context2.next = 29;
        return (0,data_build_module/* dispatch */.JD)(onboarding_constants_STORE_NAME).invalidateResolution('getProfileItems');
      case 29:
  ...
  return regenerator_default().wrap(function updateCoreProfilerStep$(_context3) {
    while (1) switch (_context3.prev = _context3.next) {
      ...
      case 22:
        _context3.prev = 22;
        _context3.next = 25;
        return (0,data_build_module/* dispatch */.JD)(onboarding_constants_STORE_NAME).invalidateResolution('getProfileProgress');
      case 25:
        _context3.next = 27;
        return (0,data_build_module/* dispatch */.JD)(onboarding_constants_STORE_NAME).invalidateResolution('getCoreProfilerCompletedSteps');
      case 27:
        _context3.next = 29;
        return (0,data_build_module/* dispatch */.JD)(onboarding_constants_STORE_NAME).invalidateResolution('getMostRecentCoreProfilerStep');
      case 29:
...
var payment_settings_action_types_ACTION_TYPES = /*#__PURE__*/function (ACTION_TYPES) {
  ...
  ACTION_TYPES["UPDATE_OFFLINE_PAYMENT_GATEWAY_ORDERING"] = "UPDATE_OFFLINE_PAYMENT_GATEWAY_ORDERING";
  return ACTION_TYPES;
}({});
;// CONCATENATED MODULE: ../../packages/js/data/src/payment-settings/utils.ts

function payment_settings_utils_ownKeys(e, r) {
  var t = Object.keys(e);
  if (Object.getOwnPropertySymbols) {
    var o = Object.getOwnPropertySymbols(e);
    r && (o = o.filter(function (r) {
...
function payment_settings_utils_objectSpread(e) {
  for (var r = 1; r < arguments.length; r++) {
    var t = null != arguments[r] ? arguments[r] : {};
    r % 2 ? payment_settings_utils_ownKeys(Object(t), !0).forEach(function (r) {
      (0,defineProperty/* default */.A)(e, r, t[r]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : payment_settings_utils_ownKeys(Object(t)).forEach(function (r) {
      Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r));
    });
  }
  return e;
 ...
 */
var parseOrdering = function parseOrdering(items) {
  return items.reduce(function (acc, item, index) {
    return payment_settings_utils_objectSpread(payment_settings_utils_objectSpread({}, acc), {}, (0,defineProperty/* default */.A)({}, item.id, index));
  }, {});
};
...
var payment_settings_actions_marked = /*#__PURE__*/regenerator_default().mark(togglePaymentGateway),
  payment_settings_actions_marked2 = /*#__PURE__*/regenerator_default().mark(hideGatewaySuggestion);
...
function getPaymentProvidersSuccess(providers, offlinePaymentGateways, suggestions, suggestionCategories) {
  ...
  var sortedOfflinePaymentGateways = offlinePaymentGateways;
  var offlinePaymentGatewaysOrdering = localStorage.getItem('wc_payment_ordering_offline');
  if (offlinePaymentGatewaysOrdering) {
    try {
      var ordering = JSON.parse(offlinePaymentGatewaysOrdering);
      var sorted = (0,toConsumableArray/* default */.A)(sortedOfflinePaymentGateways).sort(function (a, b) {
...
function hideGatewaySuggestion(gatewayId) {
  var result;
  return regenerator_default().wrap(function hideGatewaySuggestion$(_context2) {
    while (1) switch (_context2.prev = _context2.next) {
      case 0:
        _context2.prev = 0;
        _context2.next = 3;
        return (0,api_fetch_build_module/* default */.A)({
          path: WC_ADMIN_NAMESPACE + '/settings/payments/suggestion/' + gatewayId + '/hide',
          method: 'POST'
        });
      case 3:
        result = _context2.sent;
...
function updateOfflinePaymentGatewayOrdering(offlinePaymentGateways) {
  // Temporary until backend is ready.
  localStorage.setItem('wc_payment_ordering_offline', JSON.stringify(parseOrdering(offlinePaymentGateways)));
  return {
    type: payment_settings_action_types_ACTION_TYPES.UPDATE_OFFLINE_PAYMENT_GATEWAY_ORDERING,
...
function getOfflinePaymentGateways() {
...
var payment_settings_reducer_reducer = function reducer() {
  ...
  if (payload && 'type' in payload) {
    switch (payload.type) {
      ...
      case payment_settings_action_types_ACTION_TYPES.UPDATE_OFFLINE_PAYMENT_GATEWAY_ORDERING:
        return payment_settings_reducer_objectSpread(payment_settings_reducer_objectSpread({}, state), {}, {
          offlinePaymentGateways: payload.offlinePaymentGateways
        });
    }
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@wordpress+data@6.6.2_react@17.0.2/node_modules/@wordpress/data/build-module/components/use-dispatch/use-dispatch.js
var use_dispatch = __webpack_require__("../../node_modules/.pnpm/@wordpress+data@6.6.2_react@17.0.2/node_modules/@wordpress/data/build-module/components/use-dispatch/use-dispatch.js");
// EXTERNAL MODULE: ../../node_modules/.pnpm/@wordpress+data@6.6.2_react@17.0.2/node_modules/@wordpress/data/build-module/components/use-select/index.js + 1 modules
var use_select = __webpack_require__("../../node_modules/.pnpm/@wordpress+data@6.6.2_react@17.0.2/node_modules/@wordpress/data/build-module/components/use-select/index.js");
