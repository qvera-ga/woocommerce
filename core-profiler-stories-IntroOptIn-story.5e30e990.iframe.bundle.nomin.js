...
var IntroOptIn = function IntroOptIn(_ref) {
  ...
  }, (0,build_module.__)('Set up my store', 'woocommerce')), (0,react.createElement)(build_module_button/* default */.A, {
    className: "woocommerce-profiler-setup-store__button",
    variant: "tertiary",
    onClick: function onClick() {
      return sendEvent({
  ...
  }, (0,build_module.__)('Skip guided setup', 'woocommerce')), ((_window$wcAdminFeatur = window.wcAdminFeatures) === null || _window$wcAdminFeatur === void 0 ? void 0 : _window$wcAdminFeatur.blueprint) && (0,react.createElement)(build_module_button/* default */.A, {
    className: "woocommerce-profiler-setup-store__button",
    variant: "tertiary",
    onClick: function onClick() {
      return sendEvent({
