    ...
    return regenerator_default().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 2:
          ...
          return _context5.abrupt("return", __webpack_require__("../../plugins/woocommerce/client/admin/client lazy recursive ^\\.\\/.*$ include: (?:\\/plugins\\/woocommerce\\/client\\/admin\\/client(?:\\/(?%21\\.)(?:(?:(?%21(?:^%7C\\/)\\.).)*?)\\/%7C\\/%7C$)stories\\/(?%21\\.)(?=.)[^/]*?\\.story\\.(js%7Ctsx))$")("./" + pathRemainder));
        case 4:
        case "end":
...
/******/ __webpack_require__.O(0, [2583], () => (__webpack_exec__("./storybook-config-entry.js")));
